...
CREATE TABLE house (
  ...
  PRIMARY KEY (id)
) ENGINE=InnoDB AUTO_INCREMENT=26  COMMENT=''房屋信息表'';
...
CREATE TABLE house_picture (
  ...
  PRIMARY KEY (id)
) ENGINE=InnoDB AUTO_INCREMENT=86  COMMENT=''房屋图片信息'';
...
) ENGINE=InnoDB AUTO_INCREMENT=10  COMMENT=''预约看房信息表'';
...
) ENGINE=InnoDB AUTO_INCREMENT=22  COMMENT=''房屋标签映射关系表'';
...
CREATE TABLE role (
  ...
  KEY user_id (user_id)
) ENGINE=InnoDB AUTO_INCREMENT=9  COMMENT=''用户角色表'';
...
) ENGINE=InnoDB AUTO_INCREMENT=9  COMMENT=''用户基本信息表'';
